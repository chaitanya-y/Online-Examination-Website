...
<body>
	...
	<div class="hero">
	<h2 style="color: #7FFF00" >We are Hiring</h2>
  ...
  <form class="form-container" name="formcontainer" action="stuthank.php" method="post"><br><br>		 		
  	<div class="form-group">
			<div class="form-group">
              <label for="fname" style="color: #7FFF00;">First Name</label>
              <input type="text" name="fname" class="form-control" placeholder="first name"  required>
			</div>
          
          <div class="form-group">
              <label  for="lname" style="color: #7FFF00;">Last Name</label>
...
<div class="form-group">
    <label for="password" style="color: #7FFF00;">Confirm Password</label>
     <input type="password" name="confirm_password" class="form-control" placeholder="number,charecter,min,6" pattern="(?=.*\d)(?=.*[a-z]).{6,}" title="Must contain at least one number and at least 6 or more characters" size="16" placeholder="Password" required>
          ...
          <div class="form-group">
              <label for="studentID" style="color: #7FFF00;">Roll Number</label>
          ...
          <div class="form-group">
    				...
    				<input type="email" name="email" class="form-control" placeholder="Email"  required>
 		 			...
 		 			<div class="form-group">
              <label for="date of birth" style="color: #7FFF00">Date Of Birth</label>
              <input type="date" name="date" class="form-control" placeholder="date of birth" required>
          </div>
          <div class="branch"></div>
			<br>
          <div class="form-group">
              <label for="branch" style="color: #7FFF00;">Branch</label>       
