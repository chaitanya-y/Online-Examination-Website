...
<head>
	...
	<!link href="cregister.css" rel="stylesheet" type="text/css">
...
<body>
	...
	<div class="row">
	<ul class="main-nav">
		<li><a href="http://go-speedy-go.com">Contact us</a></li>
	</ul>
	</div>
	...
	<img src="logo2.png" "/>
		...
		<form class="form-container" name="formcontainer" action="login.php?q=loginforexam.php" method="post">
      ...
      <label for="password" style="color: #7FFF00">Password</label>
	...
	<p1 class="btn btn-full">Go-Speedy-Go <br>You drive we care</p1>
	</div>
	</div>
		
		
					<div class="button-awesome">
					<button type="submit" class="btn btn-full" style="color: black">Login To Take Your Exam</button>
					</div>

		</form>
					<marquee class="mar">All the best</marquee>
	</header>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:#7FFF00">Developers</span></h4>
      </div>
...
<!--Modal for admin login-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title"><span style="color:#7FFF00;font-family:'typo' ">LOGIN</span></h4>
      </div>
      <div class="modal-body title1">
<div class="row">
<div class="col-md-3"></div>
<div class="col-md-6">
<form role="form" method="post" action="admin.php?q=loginforexam.php">
<div class="form-group">
